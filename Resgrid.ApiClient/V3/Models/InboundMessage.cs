...
{
	/// <summary>
	/// Represents the model of an Inbound message
	/// Code copied from: https://github.com/wildbit/postmark-dotnet/blob/master/src/Postmark/Model/PostmarkInboundMessage.cs
	/// </summary>
